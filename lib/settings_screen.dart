...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void _showAccountSyncDialog() async {
    final deviceId = await LeaderboardApiService.instance.getUserId();
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          title: Row(
            children: [
              const Icon(Icons.sync, color: Color(0xFF2196F3), size: 28),
              const SizedBox(width: 12),
              Text(
                'Sync Account',
                style: GoogleFonts.saira(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text(
                  'Use the same account on multiple devices (mobile, browser, etc.)',
                  style: GoogleFonts.saira(
                    color: Colors.white70,
                    fontSize: 14,
                  ),
                      ...
                      ElevatedButton.icon(
                        onPressed: () async {
                          ...
                          await prefs.setString(
                            'online_leaderboard_user_id',
                            newId,
                          );

                          // Sync scores immediately
                          final success =
                              await LeaderboardApiService.instance
                                  .syncAllScores();
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                success
                                    ? '✅ Account synced! Your scores are now linked.'
                                    : '⚠️ Device ID updated, but sync failed. Check internet.',
                                style: GoogleFonts.saira(),
                              ),
                              backgroundColor:
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '1. On your mobile: Copy your Device ID\n'
                        '2. On your browser: Paste that ID here\n'
                        '3. Click "Apply ID & Sync"\n'
                        '4. Both devices now share the same account!',
                        style: GoogleFonts.saira(
                          color: Colors.white70,
                          fontSize: 11,
                          height: 1.4,
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          // Account Sync Button
                          _buildSettingsButton(
                            title: 'Sync Account Across Devices',
                            icon: Icons.sync,
                            color: const Color(0xFF2196F3),
                            onTap: () {
                              _showAccountSyncDialog();
                            },
                          ),
